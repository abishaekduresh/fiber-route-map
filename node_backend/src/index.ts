...
import tenantRoutePointTemplateRoutes from './routes/tenantRoutePointTemplateRoutes.js';
...
app.use('/api/tenant/route-point-templates', tenantRoutePointTemplateRoutes);
