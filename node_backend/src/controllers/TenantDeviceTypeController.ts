...
export class TenantDeviceTypeController {
  ...
  private transform = (dt: any) => ({
    ...
    attributes: {
      ...
      widgetUuid: dt.widgetUuid ?? null,
      widgetName: dt.widgetName ?? null,
      widgetCode: dt.widgetCode ?? null,
      widgetIconType: dt.widgetIconType ?? null,
      widgetSvgTemplate: dt.widgetSvgTemplate ?? null,
      widgetIconUrl: dt.widgetIconUrl ?? null,
