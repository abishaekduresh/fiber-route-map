...
## Version
**Current Version:** 1.73.0 — No API/DB changes; frontend-only fixes (pinned footer, pointType resolution, RPT searchable dropdown, light theme, map marker sequence numbers)
