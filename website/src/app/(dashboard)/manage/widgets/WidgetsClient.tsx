...
import {
  getWidgets, deleteWidget,
  WidgetData, WidgetType, WidgetStatus,
} from '@/lib/api';
...
export default function WidgetsClient() {
  ...
  const canUpdate = hasPermission('widget.update');
  const canDelete = hasPermission('widget.delete');
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const res = await getWidgets({ page, limit: PER_PAGE, search, status: statusFilter, type: typeFilter });
      ...
      <div className={styles.tableContainer}>
        ...
        <div className={styles.tableHeader}>
          <div className={styles.headerTop}>
            <h2 className={styles.tableTitle}>Widgets</h2>
