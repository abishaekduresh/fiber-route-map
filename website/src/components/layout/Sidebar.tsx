  ...
  const navLinks = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: 'Device Categories', href: '/manage/device-categories', icon: icon(<><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></>), permission: 'device_categories.view' },
        { name: 'Device Types',      href: '/manage/device-types',      icon: icon(<><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></>), permission: 'device_types.view' },
        { name: 'Route Point Templates', href: '/manage/route-point-templates', icon: icon(<><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 000 4h6a2 2 0 000-4M9 5a2 2 0 012-2h2a2 2 0 012 2" /></>), permission: 'route_point_templates.view' },
