...
## Version
**Current Version:** 1.69.0 — Route Point Templates table: icon column (shows device type or RPT icon), view modal with 10 flag groups and green/grey badges, Edit shortcut from view
