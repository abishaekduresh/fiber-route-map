...
## Version
**Current Version:** 1.60.0 (Route point name/description, hover tooltips, midpoint insert, route line hover popup, map focus on route selection, edit panel close button)
