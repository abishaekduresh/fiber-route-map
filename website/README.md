...
## Version
**Current Version:** 1.71.0 — Fix: route save no longer fails; RPT field data now stored in `tenant_route_point_details` table instead of a missing `fieldData` column
